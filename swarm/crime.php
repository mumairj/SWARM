...
// $subCrime=$item['value'];
// $totalCrimeTweets=$totalCrimeTweets+$subCrime;
// }
// echo $totalCrimeTweets;

// $highMapDataCrimePerc="[";
// $cr=0;
// foreach($resultCrime as $item) {
//     $sub=$item['key'];
//     $subCrime=$item['value'][0];
//     // echo $subCrime."<br>";
//     $subCrimePerc = round((($subCrime*100)/$totalCrimeTweets),2);
//     if($cr==0)
//     {
//         $highMapDataCrimePerc=$highMapDataCrimePerc."["."'".$sub."',".$subCrimePerc."]";
//     }
//     else
//     {
//         $highMapDataCrimePerc=$highMapDataCrimePerc.",['".$sub."',".$subCrimePerc."]";
...
$responseCrime=file_get_contents('http://115.146.95.134:5984/harvest_final/_design/suburbwisesents/_view/positive?group_level=1&reduce=true&sorted=true');
$responseCrime = json_decode($responseCrime, true);
$resultCrime=$responseCrime['rows'];
